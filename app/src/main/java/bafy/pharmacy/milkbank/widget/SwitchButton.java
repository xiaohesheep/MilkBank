package bafy.pharmacy.milkbank.widget;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        switch (View.MeasureSpec.getMode(widthMeasureSpec)) {
            ...
            case View.MeasureSpec.UNSPECIFIED:
                widthMeasureSpec = View.MeasureSpec.makeMeasureSpec((int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 56, getResources().getDisplayMetrics())
        ...
        switch (View.MeasureSpec.getMode(heightMeasureSpec)) {
            case View.MeasureSpec.AT_MOST:
            case View.MeasureSpec.UNSPECIFIED:
                heightMeasureSpec = View.MeasureSpec.makeMeasureSpec((int) (View.MeasureSpec.getSize(widthMeasureSpec) * mAspectRatio)
